...
export function Login() {
    ...
    return (
        <AuthLayout
            title="Welcome back"
            subtitle="Sign in to your ApexAI dashboard"
        >
            <form onSubmit={handleSubmit} className="space-y-6">
                ...
                <button
                    type="submit"
                    disabled={isLoading}
                    className="w-full bg-foreground text-background dark:bg-brand-500 dark:text-white py-3 rounded-xl font-bold text-lg transition-transform hover:scale-[1.02] shadow-xl flex items-center justify-center gap-2 disabled:opacity-70 disabled:hover:scale-100"
                >
                    {isLoading ? (
                        <>
